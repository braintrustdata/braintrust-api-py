...
class UsersResource(SyncAPIResource):
    ...
    def list(
        self,
        *,
        email: Union[str, SequenceNotStr[str]] | NotGiven = NOT_GIVEN,
        ending_before: str | NotGiven = NOT_GIVEN,
        family_name: Union[str, SequenceNotStr[str]] | NotGiven = NOT_GIVEN,
        given_name: Union[str, SequenceNotStr[str]] | NotGiven = NOT_GIVEN,
