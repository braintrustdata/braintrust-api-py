...
__all__ = ["PromptFeedbackParams", "Feedback"]


class PromptFeedbackParams(TypedDict, total=False):
...
class Feedback(TypedDict, total=False):
    id: Required[str]
    """The id of the prompt event to log feedback for.

    This is the row `id` returned by `POST /v1/prompt/{prompt_id}/insert`
    """
