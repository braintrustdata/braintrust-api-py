...
from braintrust_api.types import organization_update_params
from braintrust_api.types import organization_list_params
...
class TestOrganization:
    ...
    def test_streaming_response_retrieve(self, client: Braintrust) -> None:
        with client.organization.with_streaming_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response :
    ...
    def test_path_params_retrieve(self, client: Braintrust) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `organization_id` but received ''"):
          client.organization.with_raw_response.retrieve(
              "",
          )
...
class TestAsyncOrganization:
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncBraintrust) -> None:
        async with async_client.organization.with_streaming_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response :
            assert not response.is_closed
            assert response.http_request.headers.get('X-Stainless-Lang') == 'python'
    ...
    async def test_path_params_retrieve(self, async_client: AsyncBraintrust) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `organization_id` but received ''"):
          await async_client.organization.with_raw_response.retrieve(
              "",
          )
