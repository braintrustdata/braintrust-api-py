...
class TestTopLevel:
    ...
    @parametrize
    def test_method_hello_world(self, client: Braintrustdata) -> None:
        top_level = client.top_level.hello_world()
        assert_matches_type(str, top_level, path=["response"])

    @parametrize
    def test_raw_response_hello_world(self, client: Braintrustdata) -> None:
    ...
    @parametrize
    def test_streaming_response_hello_world(self, client: Braintrustdata) -> None:
...
class TestAsyncTopLevel:
    ...
    @parametrize
    async def test_method_hello_world(self, async_client: AsyncBraintrustdata) -> None:
        top_level = await async_client.top_level.hello_world()
        assert_matches_type(str, top_level, path=["response"])

    @parametrize
    async def test_raw_response_hello_world(self, async_client: AsyncBraintrustdata) -> None:
    ...
    @parametrize
    async def test_streaming_response_hello_world(self, async_client: AsyncBraintrustdata) -> None:
