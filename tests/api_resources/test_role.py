...
from braintrust_api.types import role_create_params
from braintrust_api.types import role_update_params
from braintrust_api.types import role_list_params
from braintrust_api.types import role_replace_params
...
class TestRole:
    ...
    def test_method_create_with_all_params(self, client: Braintrust) -> None:
        role = client.role.create(
            ...
            member_roles=["182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e", "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e", "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"],
            org_name="org_name",
        )
        assert_matches_type(Role, role, path=['response'])
    ...
    def test_method_update_with_all_params(self, client: Braintrust) -> None:
        role = client.role.update(
            ...
            add_member_roles=["182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e", "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e", "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"],
            description="description",
            name="name",
            ...
            remove_member_roles=["182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e", "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e", "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"],
        )
        assert_matches_type(Role, role, path=['response'])
